...
public class DataService {
    ...
    public List<Person> getProfessors() {
        return runSimpleQuery(ReadQueries.getAll("professors", "professor_surname, professor_name"), rset ->
    ...
    public List<Person> getStudents() {
        return runSimpleQuery(ReadQueries.getAll("students", "student_surname, student_name"), rset ->
                new Person(rset.getInt(1),
                        rset.getString(2),
                        rset.getString(3),
                        rset.getString(4),
